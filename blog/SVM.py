...
class SVM:
	def __init__(self,kernel):
		...
		self.tfidf = TfidfVectorizer(sublinear_tf=True, use_idf=True, smooth_idf=True, stop_words='english', token_pattern=self.pattern, ngram_range=(1, 4))
...
if __name__ == '__main__':
	if len(sys.argv) not in [7, 8]:
		sys.exit('\nUsage:\n    Validate:\n\tpython SVM.py -k linear -t ./data/train.txt -v ./data/validate.txt\n    Classify:\n\tpython SVM.py -k linear -t ./data/raw.txt -c ./data/test.txt ./data/result.txt')
